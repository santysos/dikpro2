    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Ventas',
                    'url'  => 'reportes/ordenes1',
                    'icon' => 'fas fa-chart-line',

                ],
                [
                    'text' => 'Eficiencia en Entrega',
                    'url'  => 'reportes/entrega',
                    'icon' => 'fas fa-check',
                ],
                [
                    'text' => 'Facturadas',
                    'url'  => 'reportes/facturados',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Departamentos',
                    'url'  => 'departamento/departamentos',
                    'icon' => 'fa fa-suitcase',

                ],
                [
                    'text' => 'Procesos',
                    'url'  => 'departamento/procesos',
                    'icon' => 'fa fa-tasks',
                ],

                [
                    'text' => 'Productos',
                    'url'  => 'departamento/productos',
                    'icon' => 'fa fa-print',
                ],
                [
                    'text' => 'Servicios',
                    'url'  => 'departamento/servicios',
                    'icon' => 'fa fa-list',
                ],
            ],
        ],
